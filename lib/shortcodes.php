...
function register_button_3($buttons) {  
   array_push($buttons, "alert", "video", "separatorheadline", "toggle", "visibility", "teaser");  
   return $buttons;  
}
...
function add_plugin($plugin_array) {
  ...
  $plugin_array['one_half'] = get_template_directory_uri().'/assets/tinymce/tinymce.js';
  $plugin_array['one_third'] = get_template_directory_uri().'/assets/tinymce/tinymce.js';
  $plugin_array['two_third'] = get_template_directory_uri().'/assets/tinymce/tinymce.js';
  $plugin_array['one_fourth'] = get_template_directory_uri().'/assets/tinymce/tinymce.js';
  $plugin_array['three_fourth'] = get_template_directory_uri().'/assets/tinymce/tinymce.js';
  $plugin_array['one_fifth'] = get_template_directory_uri().'/assets/tinymce/tinymce.js';
